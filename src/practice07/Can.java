...
public class Can extends Item {
	...
	public Can(int width, int height, int weight) {
	...
	@Override
	public int sellItem() {
		return super.getWeight() * 1000;
	}

	@Override
	public void shakeItem() {
		System.out.println("캔을 흔들었습니다.");
		System.out.println("열면 폭발할 것 같아요!");
	}

	@Override
	public void openItem() {
		System.out.println("캔을 열었습니다.");
		System.out.println("맛있는 참치가 들어있네요!");
	}
}
