...
public class Box extends Item {
	...
	@Override
	public int sellItem() {
		return (super.getWidth() + super.getHeight()) * super.getWeight();
	}

	@Override
	public void shakeItem() {
		System.out.println("박스를 흔들었습니다.");
		System.out.println("어제 중*나라에서 산 스피커가 들어있을까요?");
	}

	@Override
	public void openItem() {
		System.out.println("박스를 열었습니다.");
		System.out.println("벽돌이 들어있네요!");
	}
}
